...
const page = ({ params }: { params: { username: string } }) => {
  ...
  return (
    ...
    //             height={80}
    //           />
    //           <h1 className="mb-2 text-2xl">User Profile</h1>
    //           <span className="text-gray-300">{user?.name}'s Details:</span>
    //         </div>
    //         <div className="mb-4 text-lg">
    //           <p className="text-white mb-2">Name: {user?.name}</p>
    //         </div>
    //         <div className="mb-4 text-lg">
    ...
    //   <div className=" w-10/12 mx-auto my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
      ...
      <>
        {user && (
          <UserProfile
            ...
            is_name_public={user?.is_name_public}
          ...
          <div className="text-white">
            <div className="mb-8 flex flex-col items-center">
              ...
              <span className="text-gray-300">
                {user?.public_name}'s Details:
              </span>
            </div>
            <div className="mb-4 text-lg">
              <p className="text-white mb-2">Name: {user?.public_name}</p>
            </div>
            {user?.is_email_public && (
              <div className="mb-4 text-lg">
                <p className="text-white mb-2">Email: {user?.public_email}</p>
              </div>
            )}
            <div className="mb-4 text-lg">
              <p className="text-white">ID: {user?.id}</p>
            ...
            <div className="mb-4 text-lg">
              <p className="text-white">Created at: {user?.created_at}</p>
            </div>
            <div className="mb-4 text-lg">
              <p className="text-white">Updated at: {user?.updated_at}</p>
            </div>
          </div>
        </div>
      </div> */}
