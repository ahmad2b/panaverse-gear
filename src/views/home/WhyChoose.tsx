    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-32">
      <div className="grid md:grid-cols-2 gap-12">
        <div className="lg:w-3/4">
          ...
          <div className="text-lg w-fit mt-8">
            <DarkButton
              buttonText="Join Panaverse DAO Today"
              webLink="/enroll"
            />
          </div>
        </div>
        ...
        <div className="space-y-6 lg:space-y-10">
          <div className="flex">
            ...
            <div className="ml-5 sm:ml-8">
              <h3 className="">Expert Instructors</h3>
              <p className="mt-1 text-slate-600 ">
                Learn from industry professionals with extensive knowledge and
          ...
          <div className="flex">
            ...
            <div className="ml-5 sm:ml-8">
              <h3 className="">Flexible Learning</h3>
              <p className="mt-1 text-slate-600">
                Study at your own pace with our easy-to-follow courses designed
          ...
          <div className="flex">
            ...
            <div className="ml-5 sm:ml-8">
              <h3 className="">Hands-on Experience</h3>
              <p className="mt-1 text-slate-600">
                Apply your knowledge through real-world projects and practical
          ...
          <div className="flex">
            ...
            <div className="ml-5 sm:ml-8">
              <h3 className="">Community Support</h3>
              <p className="mt-1 text-slate-600">
                Connect with fellow learners and instructors in our supportive
                community, and receive guidance throughout your learning
                journey.
              </p>
            </div>
          </div>
