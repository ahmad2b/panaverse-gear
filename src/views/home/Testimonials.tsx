...
const Testimonials = () => {
  const testimonials = [
    {
      avatar:
        "https://img.freepik.com/premium-photo/3d-rendering-zoom-call-avatar_23-2149556774.jpg?w=996",
      name: "Exisiting Student",
      title: "Lahore Student",
      quote:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et est hendrerit, porta nunc vitae.",
    },
    {
      avatar:
        "https://img.freepik.com/premium-photo/3d-rendering-zoom-call-avatar_23-2149556773.jpg?w=996",
      name: "New Student",
      title: "Islamabad Student",
      quote:
        "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.",
    },
    {
      avatar:
        "https://img.freepik.com/free-photo/3d-rendering-zoom-call-avatar_23-2149556785.jpg?w=996&t=st=1680933870~exp=1680934470~hmac=fb1c4d405b33ae40eaa9362e0d00c9ba44f2e3226ae29be5058d918e2b04d7e2",
      name: "Former Student",
      title: "Karachi Student",
      quote:
        "There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain.",
    },
  ];
  return (
    <div className="relative py-14 mt-28">
        ...
        <div className="mt-12">
          <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item, idx) => (
              <li
                key={idx}
                className="bg-white rounded-xl border shadow-md shadow-black"
              >
                <div className="p-4">
                  <svg
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(152.92deg, rgba(0, 0, 0, 1) 4.54%, rgba(0, 0, 0, 1) 34.2%, rgba(0, 0, 0, 1) 77.55%)",
        }}
      ></div>
    </div>
  );
